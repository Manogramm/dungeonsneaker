...
function moveUp() { 
	...
	if (hero.movement < 1){
		...
		if (hero.positionNumber < 16 || upperField.className == "light" || upperField.className == "blind" || upperField.className == "gravel" || upperField.className == "sack" || upperField.className == "goblin" || upperField.className == "lich" || upperField.className == "goblinArcher"){
			movePossible = true;
		}
		if(hero.positionNumber < 16){
			movePossible = false;
		}
...
function okay(){
	...
	if(dungeon.iconsAltered == true){
		...
		//for loop through dungeon.monsterList
	}
